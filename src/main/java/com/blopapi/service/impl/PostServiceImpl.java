...
public class PostServiceImpl implements PostService {
    ...
    public List<PostDto> getAllPosts(int pageNo, int pageSize, String sortBy, String sortDir) {
        //Turnary operator : Turnary operator is a replacement for if/else conditions.
        Sort sort=sortDir.equalsIgnoreCase(Sort.Direction.ASC.name())?Sort.by(sortBy).ascending():Sort.by(sortBy).descending();

        Pageable pageable = PageRequest.of(pageNo, pageSize, sort);//Sort.by(sortBy): Generating "String sortBy" to Sort object.Because sortBy is a string and pagable taking only Sort objects.
